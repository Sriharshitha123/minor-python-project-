...
--
-- Host: localhost
-- Generation Time: Sep 27, 2022 at 08:14 AM
...
--
-- Database: `social_spammer_detection`
--
CREATE DATABASE IF NOT EXISTS `social_spammer_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `social_spammer_detection`;
...
('38n9ig5lj6k4qcrj4j87dww9sd6rc9wc', 'eyJ1c2VyaWQiOjJ9:1od5g9:hKBuj4SmXnD8kQwtTK5DE7kWFxkHrRqmXaPJmbM6MYQ', '2022-10-11 08:10:57.897299'),
...
('da6mbo20edyt1wpyjvtqcpc921s7e8dy', 'eyJ1c2VyaWQiOjF9:1od55a:rwLXkPvOQpfFDtY5diAwWOUvpDvv3d0vMOourTQNP5c', '2022-10-11 07:33:10.960720'),
...
(33, 'Naive Bayes', '94.33755670264352'),
(34, 'SVM', '96.21460972939153'),
(35, 'Logistic Regression', '96.04254653527295'),
(36, 'Decision Tree Classifier', '95.04145158767402');
...
(13, 'Spammer Tweet', '33.33333333333333'),
(14, 'Normal Tweet', '66.66666666666666');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_tweet_text_detection_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_tweet_text_detection_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_tweet_text_detection_type`
--

INSERT INTO `remote_user_tweet_text_detection_type` (`id`, `Tweet_Message`, `Prediction`) VALUES
(1, '@user #cnn calls #michigan middle school ''build the wall'' chant '''' #tcot  \r\n', 'Spammer Tweet'),
(2, 'we had a great panel on the mediatization of the public service   #ica16\r\n', 'Normal Tweet'),
(3, 'yup, being a knicks fan is hard, so its easier to just be an nba fan when the playoffs roll around Ã°ÂŸÂ˜ÂŽ \r\n', 'Normal Tweet'),
(4, 'for her #bihday we got her a #nose #job @user  Ã°ÂŸÂŽÂˆÃ°ÂŸÂÂ¶Ã°ÂŸÂŽÂ‰Ã°ÂŸÂŽÂ‚Ã°ÂŸÂŽÂ    #bihday #petunia we love you Ã°ÂŸÂ™Âƒ \r\n', 'Normal Tweet'),
(5, 'yes it''s  when you call #michelleobama a gorilla because racists have long thought of black people as no betÃ¢Â€Â¦ \r\n', 'Spammer Tweet'),
(6, 'good morning friday! what is everyone doing this weekend? #goodmorning #friday #girls   #love #florida \r\n', 'Normal Tweet');
